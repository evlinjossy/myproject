...
class MusicUpdateDataSerializer(serializers.Serializer):
...
class MusicUpdateResponseSerializer(ApiResponseSerializer):
    data = MusicUpdateDataSerializer(required=False)
